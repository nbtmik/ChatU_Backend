...
// //Create new user and save it to the database and save token in cookie
...
//     return res.status(200).cookie("ChatU-token","",{...cookieOptions,maxAge:0}).json({
//         success:true,
...
//     //finding all users except me and my frineds
